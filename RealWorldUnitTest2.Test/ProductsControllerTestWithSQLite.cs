...
{
  public class ProductsControllerTestWithSQLite : ProductsControllerTest
  {
    public ProductsControllerTestWithSQLite()
    {
      SqliteConnection connection = new SqliteConnection("DataSource=:memory:");
      connection.Open();
      SetContextOptions(new DbContextOptionsBuilder<DbUnitTestContext>().UseSqlite(connection).Options);
    }
